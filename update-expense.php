...
if (strlen($_SESSION['detsuid'] == 0)) {
	...
	if (isset($_POST['update'])) {
		...
		$sam = "select amount,cate_id from expense_master where expense_id = '$_GET[updateid]';";
		...
		if ($am != $amount && $cid != $cate_id) {
			...
			$re = mysqli_fetch_array($q2);
			$amb = $re['amount'];
			echo "<script>alert('$amb budget of cat before addd expense');</script>";
			$amb = $amb + $am;
			$uam = "update budget_master set amount = $amb where cate_id=$c_id";
			$re = mysqli_query($con, $uam);
			if ($am <= 0) {
				echo "<script>alert('$amb ...............................out of budget.......................................');</script>";
			} else {
				echo "<script>alert('$amb budget remaining');</script>";
			}



			$sam = "select amount from budget_master where cate_id=$cate_id";
			$q2 = mysqli_query($con, $sam);
			$re = mysqli_fetch_array($q2);
			$amb = $re['amount'];
			echo "<script>alert('$amb budget of cat before addd expense');</script>";
			$amb = $amb - $amount;
			$uam = "update budget_master set amount = $amb where cate_id=$cate_id";
			$re = mysqli_query($con, $uam);
			if ($am <= 0) {
				echo "<script>alert('$amb ...............................out of budget.......................................');</script>";
			} else {
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			$samc1 = "select amount from budget_master where cate_id=$cid";
			$q123 = mysqli_query($con, $samc1);
			$re123 = mysqli_fetch_array($q123);
			$amc = $re123['amount'];
			echo "<script>alert('$amc budget of cat before update expense');</script>";
			$amc = $amc + $amount;
			$uam = "update budget_master set amount = $amc where cate_id=$cid";
			$re123 = mysqli_query($con, $uam);
			if ($amc <= 0) {
				echo "<script>alert('$amc ...............................out of budget.......................................');</script>";
			} else {
				echo "<script>alert('$amc budget remaining');</script>";
			}


			$samc2 = "select amount from budget_master where cate_id=$cate_id";
			$q1234 = mysqli_query($con, $samc2);
			$re1234 = mysqli_fetch_array($q1234);
			$amcc = $re1234['amount'];
			echo "<script>alert('$amcc budget of cat before update expense');</script>";
			$amcc = $amcc - $amount;
			$uam = "update budget_master set amount = $amcc where cate_id=$cate_id";
			$re1234 = mysqli_query($con, $uam);
			if ($amcc <= 0) {
				echo "<script>alert('$amcc ...............................out of budget.......................................');</script>";
			} else {
				echo "<script>alert('$amcc budget remaining');</script>";
			}
		}
...
?>
	...
	<head>
		...
		<title>DHFM ||Update  Expense</title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Expense / Manage Expenses / Update Expense</li>
				</ol>
			</div><!--/.row-->
