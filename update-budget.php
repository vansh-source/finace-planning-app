...
if (strlen($_SESSION['detsuid'] == 0)) {
	...
	if (isset($_POST['update'])) {
		...
		$query = mysqli_query($con, "update budget_master set amount ='$amount',set_amount ='$set_amount',start_date='$start_date',cate_id ='$cate_id',end_date='$end_date' where budget_id = '$_GET[updateid]';");;
		if ($query) {
...
?>
	...
	<head>
		...
		<title>DHFM || Update Budget</title>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			<div class="row">
				<ol class="breadcrumb">
					...
					<li class="active">Budget / Manage Budget / Update Budget </li>
				</ol>
			</div><!--/.row-->
						...
						<div class="panel-body">
							...
							<div class="col-md-12">
								...
								if (isset($_GET['updateid'])) {
									...
									$ret = mysqli_query($con, "SELECT budget_master.start_date, budget_master.amount,budget_master.set_amount,budget_master.end_date,category_master.cate_name
								...
								?>
										<form role="form" method="post" action="">
											...
											<div class="form-group">
												...
												<input class="form-control" type="number" value="<?php echo $row['set_amount']; ?>" required="true" name="set_amount">
											</div>
